...
const Sidebar: React.FC<Props> = ({ navIsSticky, hide }) => {
  ...
  return (
    <>
      ...
      <div
        className={`sidebar fixed dark:bg-primarylessDark dark:text-textLighter z-40 h-[calc(100vh)] transition-all lg:transition-none bottom-0 duration-300 inset-y-0 pt-[82px] lg:pt-0 bg-white transform ${
      ...
      >
        ...
        >
          <div className="mb-5 flex flex-col xl:flex-row text-center xl:text-left items-center gap-3 group">
            <UserImage
              className="min-w-[5rem] w-20 lg:w-[4.5rem] min-h[5rem] h-20"
