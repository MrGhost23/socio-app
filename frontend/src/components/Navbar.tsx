        ...
        <div className="w-full mr-auto max-w-xs xl:max-w-lg 2xl:max-w-2xl bg-gray-100 rounded-md hidden lg:flex items-center">
          <form className="flex items-center w-full">
            ...
            <div className="relative w-full">
              ...
              <input
                type="text"
                className="bg-gray-200 border outline-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:bg-gray-50"
                placeholder="Search..."
                required
              />
            </div>
          ...
          <ul className="ml-4 xl:w-48 flex items-center gap-2 justify-end">
            ...
            <li className="ml-2 lg:ml-4 relative inline-block">
              <a className="" href="">
                ...
                <AiFillMessage className="text-2xl text-gray-700" />
              </a>
            </li>
            <li className="ml-2 lg:ml-4 relative inline-block">
