...
const Post: React.FC<Props> = ({ currentUserFullName, currentUserImage, post }) => {
  return (
    <Card className='mb-6 px-8 py-6 !text-left'>
      <div className='mb-2 flex flex-row justify-between gap-3'>
        <div className='flex flex-row gap-3'>
        <UserImage className='w-14' src={post.authorImage} alt={post.authorFullName} />
      ...
      <div className='flex flex-col'>
        ...
        <PostCommentForm currentUserImage={currentUserImage} currentUserFullName={currentUserFullName} />
      </div>
    </Card>
  );
};
